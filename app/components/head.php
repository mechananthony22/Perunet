...
<head>
    ...
    <meta property="og:image" content="<?= htmlspecialchars($ogImage ?? '/perunet/public/img/EMPRESA/p.png') ?>">
    ...
    <meta property="twitter:image" content="<?= htmlspecialchars($ogImage ?? '/perunet/public/img/EMPRESA/p.png') ?>">
