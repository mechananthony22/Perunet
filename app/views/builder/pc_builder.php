    ...
    <div class="container mx-auto px-4 pb-32">
        ...
        <?php if ($currentCategory): ?>
            <div class="bg-white border-2 border-blue-200 rounded-xl p-6 mb-4 shadow-sm">
                <div class="flex items-center">
                    <i class="fa fa-microchip text-blue-600 text-4xl mr-4"></i>
                    <div>
        ...
        <?php if (!empty($subcategories)): ?>
            <div class="flex flex-wrap gap-4 mb-8 justify-center">
                <button class="filter-btn active bg-blue-600 text-white px-6 py-2 rounded-full font-bold transition shadow-md hover:bg-blue-700" data-filter="all">
                    Todos
                </button>
                <?php foreach ($subcategories as $sub): ?>
                    <button class="filter-btn bg-white text-gray-700 border border-gray-300 px-6 py-2 rounded-full font-bold transition shadow-sm hover:bg-gray-100 hover:text-blue-600" data-filter="<?= $sub['id'] ?>">
                        <?= $sub['nombre'] ?>
                    </button>
                <?php endforeach; ?>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" id="products-grid">
            <?php if (!empty($products)): ?>
                <?php foreach ($products as $product): ?>
                    <div class="bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:shadow-xl hover:border-blue-400 transition-all duration-300 product-card" 
